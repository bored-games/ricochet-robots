defmodule Gameboy.SocketHandler do
  ...
  @doc """
  Take a websocket transmission and attempt to decode the JSON. If the transmission is valid, match the transmission against other more specific
  ...
  The client should periodically ping the server if no other transmissions have been sent over the socket. If no transmissions have been sent in the last 90
  seconds, the server will assume that the client has timed out and the socket will be closed. We respond with a pong.
  """
  @impl true
  ...
  Players can create new rooms, the name of which may be autogenerated. They will be made the admin of the room and joined to the room.

  Options:
    player_limit: The player limit for the new room. By default, 10.
  """
  @impl true
  ...
  @doc "get_rooms : need to send out user initialization info to client, and new user message, scoreboard to all users"
  @impl true
